...
public class ItemAureateManaSpark extends ItemBase {

    public ItemAureateManaSpark(ModX mod, Properties properties) {
    ...
    public static boolean attachSpark(Level world, BlockPos pos, ItemStack stack) {
        ...
        if (attach != null && attach.canAttachSpark(stack) && attach.getAttachedSpark() == null) {
            if (!world.isClientSide) {
                stack.shrink(1);
                EntityAureateManaSpark spark = new EntityAureateManaSpark(world);
